...
class procesadorView(APIView):
    """ Esta es la clase API que se encaga de recibir los datos y procesarlos y regresarlos """

    def get(self,request,format  = None):
        """Retornar lista de que el servido esta activo """
        lista_api = [ 'Todo OK','El servidor escucha']
        return Response({'mensaje':lista_api})
